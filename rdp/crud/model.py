...
class Device(Base):
    ...
    def __repr__(self) -> str:
        return f"Device(id={self.id!r}, name={self.device_name}), description={self.device_description})"
...
class Location(Base):
    ...
    def __repr__(self) -> str:
        return f"Device(id={self.id!r}, name={self.location_name}), description={self.location_description})"
